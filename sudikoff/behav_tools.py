...
def calc_sdt(data, coding_dict=None, measures=None):
    ...
    data : Pandas dataframe
        dataframe including subject, objective status of 
    coding_dict : dict
        dictionary with information about objective and response columns, subject column, 
        old and new values, and "old" response values
            Example:
            coding_dict = dict(objective_col='Morph', 
                       old=[1], 
                       new=[2, 3],
